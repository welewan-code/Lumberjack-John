...
func _populate_slot_tools(main: Node, tools: OptionButton, slot_index: int) -> void:
	...
	var tool_ids: Array[String] = ["wooden_axe", "sharpened_axe", "checht_axe", "fickars_axe", "frame_saw", "aku_saw", PARKSAJT_TOOL_ID, CHECHT_950_TOOL_ID]
...
func _is_known_tool(tool_id: String) -> bool:
	if tool_id == PARKSAJT_TOOL_ID or tool_id == CHECHT_950_TOOL_ID:
		return true
